...
class ConfigTests(unittest.TestCase):
    def test_defaults_are_safe(self):
        ...
        self.assertTrue(str(settings.memory_path).endswith(".jarvis/memory.db"))

    def test_environment_overrides(self):
        with patch.dict(os.environ, {"JARVIS_MEMORY_PATH": "~/test-memory.db", "JARVIS_WAKE_WORDS": "computer,jarvis"}, clear=False):
            settings = Settings.from_env()
